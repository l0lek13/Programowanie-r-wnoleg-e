...
int main()
{
	...
	printf("Sprawdzanie wrtosci zmeinnej wspolnej \n");
	...
	if(zmienna_wspolna==0)
	  printf("\t odlaczony watek potomny PRAWDOPODOBNIE ZOSTAL ZABITY\n");
	else
	  printf("\todlaczony watek potomny prawdopodobnie nie zostal zabity");
	...
	pthread_exit(0); // co stanie sie gdy uzyjemy exit(0)?
}
